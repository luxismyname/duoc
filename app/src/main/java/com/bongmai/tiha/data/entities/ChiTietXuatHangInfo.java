...
public class ChiTietXuatHangInfo {
    private Date Ngay;
    private String SoCt;
    ...
    public ChiTietXuatHangInfo getChiTietXuatHang(String jsonString) {
        Gson gson = new GsonBuilder()
                .setDateFormat("yyyy-MM-dd'T'HH:mm:ss")
                .create();
        Type type = new TypeToken<ChiTietXuatHangInfo>() {
        }.getType();
        return gson.fromJson(jsonString, type);
    }

    public ArrayList<ChiTietXuatHangInfo> getListChiTietXuatHang(String jsonString) {
        Gson gson = new GsonBuilder()
                .setDateFormat("yyyy-MM-dd'T'HH:mm:ss")
                .create();
        Type type = new TypeToken<ArrayList<ChiTietXuatHangInfo>>() {
        }.getType();
        return gson.fromJson(jsonString, type);
    }
}
