...
public class NguoiDungCuuLongInfo {
    ...
    public NguoiDungCuuLongInfo getNguoiDungCL(String jsonString) {
        Gson gson = new GsonBuilder()
                .setDateFormat("yyyy-MM-dd'T'HH:mm:ss")
                .create();
        Type type = new TypeToken<NguoiDungCuuLongInfo>() {
        }.getType();
        return gson.fromJson(jsonString, type);
    }

    public ArrayList<NguoiDungCuuLongInfo> getListNguoiDungCL(String jsonString) {
        Gson gson = new GsonBuilder()
                .setDateFormat("yyyy-MM-dd'T'HH:mm:ss")
                .create();
        Type type = new TypeToken<ArrayList<NguoiDungCuuLongInfo>>() {
        }.getType();
        return gson.fromJson(jsonString, type);
    }
}
