...
import com.bongmai.tiha.utils.AppController;

import java.util.HashMap;
import java.util.Map;


public class APIServiceDuocCuuLong {
    String URL;
    String tag = "VolleyError";
    String userName = "admin";
    String passWord = "P@ssw0rd@tihagas$";


    int MY_SOCKET_TIMEOUT_MS = 20000;

    public APIServiceDuocCuuLong(String URL) {
        this.URL = AppConstants.URL_SERVER_1 + URL;
