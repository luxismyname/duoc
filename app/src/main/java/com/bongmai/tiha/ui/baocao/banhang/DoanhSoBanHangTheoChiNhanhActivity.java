...
public class DoanhSoBanHangTheoChiNhanhActivity extends AppCompatActivity {
    ...
    BaseService service;
    DoanhSoBanHangTheoChiNhanhRecyclerViewAdapter adapterListData;
    List<DoanhSoChiNhanhInfo> listData;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doanhsobanhangtheochinhanh);
    ...
    private void configToolbar() {
        ...
        String tieuDeForm = "Doanh số theo chi nhánh";
    ...
    private void GetListData() {
        ...
        baoCaoPresenter.GetListDoanhSoBanHangTheoChiNhanh(dieuKienLoc, new BaoCaoBanHangContract.IOnGetListDoanhSoBanHangTheoChiNhanhFinishedListener() {
            @Override
            ...
            public void onError(String error) {
                ...
                listData = new ArrayList<>();
                onBindData();
                Toast.makeText(DoanhSoBanHangTheoChiNhanhActivity.this, "Lấy danh sách thất bại. Chi tiết:\n" + error, Toast.LENGTH_LONG).show();
    ...
    private void onBindData() {
        adapterListData = new DoanhSoBanHangTheoChiNhanhRecyclerViewAdapter(DoanhSoBanHangTheoChiNhanhActivity.this, listData);
        adapterListData.DataSourceChanged(new DoanhSoBanHangTheoChiNhanhRecyclerViewAdapter.DataSourceChangedListener() {
            @Override
    ...
    private void SummaryItems() {
        ...
        for (DoanhSoChiNhanhInfo item : adapterListData.getListAllData()) {
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (position == DateReportInfo.LuaChonKhac) {
                    ...
                    NhapThoiGianBaoCaoDialog.getInstance().showConfirmDialog(dieuKienLoc.getTuNgay(), dieuKienLoc.getDenNgay(), DoanhSoBanHangTheoChiNhanhActivity.this,
