...
public class DoanhSoBanHangTheoNhanVienActivity extends AppCompatActivity {
    ...
    BaseService service;
    DoanhSoBanHangTheoNhanVienRecyclerViewAdapter adapterListData;
    List<DoanhSoNhanVienInfo> listData;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doanhsobanhangtheonhanvien);
    ...
    private void GetListData() {
        ...
        baoCaoPresenter.GetListDoanhSoBanHangTheoNhanVien(dieuKienLoc, new IBaoCaoModel.IOnGetListDoanhSoBanHangTheoNhanVienFinishedListener() {
            @Override
            ...
            public void onError(String error) {
                ...
                listData = new ArrayList<>();
                onBindData();
                Toast.makeText(DoanhSoBanHangTheoNhanVienActivity.this, "Lấy danh sách phiếu xuất thất bại. Chi tiết:\n" + error, Toast.LENGTH_LONG).show();
    ...
    private void onBindData() {
        adapterListData = new DoanhSoBanHangTheoNhanVienRecyclerViewAdapter(DoanhSoBanHangTheoNhanVienActivity.this, listData);
        adapterListData.DataSourceChanged(new DoanhSoBanHangTheoNhanVienRecyclerViewAdapter.DataSourceChangedListener() {
            @Override
    ...
    private void SummaryItems() {
        ...
        for (DoanhSoNhanVienInfo item : adapterListData.getListAllData()) {
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (position == DateReportInfo.LuaChonKhac) {
                    ...
                    NhapThoiGianBaoCaoDialog.getInstance().showConfirmDialog(dieuKienLoc.getTuNgay(), dieuKienLoc.getDenNgay(), DoanhSoBanHangTheoNhanVienActivity.this,
