...
public class NhatKyBanHangChiTietActivity extends AppCompatActivity {
    ...
    BaseService service;
    NhatKyBanHangChiTietRecyclerViewAdapter adapterListData;
    List<ChiTietXuatHangInfo> listData;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nhatkybanhangchitiet);
    ...
    private void configToolbar() {
        ...
        String tieuDeForm = "Nhật ký bán hàng chi tiết";
    ...
    private void GetListData() {
        ...
        baoCaoPresenter.GetListNhatKyBanHangChiTiet(dieuKienLoc, new IBaoCaoModel.IOnGetListNhatKyBanHangChiTietFinishedListener() {
            @Override
            ...
            public void onError(String error) {
                ...
                listData = new ArrayList<>();
                onBindData();
                Toast.makeText(NhatKyBanHangChiTietActivity.this, "Lấy danh sách thất bại. Chi tiết:\n" + error, Toast.LENGTH_LONG).show();
    ...
    private void onBindData() {
        adapterListData = new NhatKyBanHangChiTietRecyclerViewAdapter(NhatKyBanHangChiTietActivity.this, listData);
        adapterListData.DataSourceChanged(new NhatKyBanHangChiTietRecyclerViewAdapter.DataSourceChangedListener() {
            @Override
    ...
    private void SummaryItems() {
        ...
        for (ChiTietXuatHangInfo item : adapterListData.getListAllData()) {
            tongSl += item.getSL();
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (position == DateReportInfo.LuaChonKhac) {
                    ...
                    NhapThoiGianBaoCaoDialog.getInstance().showConfirmDialog(dieuKienLoc.getTuNgay(), dieuKienLoc.getDenNgay(), NhatKyBanHangChiTietActivity.this,
