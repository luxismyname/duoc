...
public class CongNoTongHopActivity extends AppCompatActivity {
    ...
    BaseService service;
    CongNoTongHopRecyclerViewAdapter adapterListData;
    List<CongNoTongHopInfo> listData;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!isCongNoCuoiKy)
            setContentView(R.layout.activity_congnotonghop);
        else
            setContentView(R.layout.activity_congnotonghopcuoiky);
    ...
    private void configToolbar() {
        ...
        String tieuDeForm = "Công nợ tổng hợp";
    ...
    private void GetListData() {
        ...
        baoCaoPresenter.GetListCongNoTongHop(dieuKienLoc, new BaoCaoCongNoContract.IOnGetListCongNoTongHopFinishedListener() {
            @Override
            ...
            public void onError(String error) {
                ...
                listData = new ArrayList<>();
                onBindData();
                Toast.makeText(CongNoTongHopActivity.this, "Lấy danh sách thất bại. Chi tiết:\n" + error, Toast.LENGTH_LONG).show();
            }
        });
    }

    private void onBindData() {
        adapterListData = new CongNoTongHopRecyclerViewAdapter(CongNoTongHopActivity.this, listData, isCongNoCuoiKy);
        adapterListData.DataSourceChanged(new CongNoTongHopRecyclerViewAdapter.DataSourceChangedListener() {
            @Override
    ...
    private void SummaryItems() {
        double tongPhaiThuDK = 0, tongPhaiTraDK = 0, tongPSNhap = 0, tongPSXuat = 0, tongPSThu = 0, tongPSChi = 0, tongPhaiThuCK = 0, tongPhaiTraCK = 0;
        for (CongNoTongHopInfo item : adapterListData.getListAllData()) {
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (position == DateReportInfo.LuaChonKhac) {
                    ...
                    NhapThoiGianBaoCaoDialog.getInstance().showConfirmDialog(dieuKienLoc.getTuNgay(), dieuKienLoc.getDenNgay(), CongNoTongHopActivity.this,
