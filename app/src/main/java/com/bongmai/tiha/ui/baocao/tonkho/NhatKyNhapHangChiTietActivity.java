...
public class NhatKyNhapHangChiTietActivity extends AppCompatActivity {
    ...
    BaseService service;
    NhatKyNhapHangChiTietRecyclerViewAdapter adapterListData;
    List<ChiTietNhapHangInfo> listData;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nhatkynhaphangchitiet);
    ...
    private void configToolbar() {
        ...
        String tieuDeForm = "Nhật ký nhập hàng chi tiết";
    ...
    private void GetListData() {
        ...
        baoCaoPresenter.GetListNhatKyNhapHangChiTiet(dieuKienLoc, new BaoCaoTonKhoContract.IOnGetListNhatKyNhapHangChiTietFinishedListener() {
            @Override
            ...
            public void onError(String error) {
                ...
                listData = new ArrayList<>();
                onBindData();
                Toast.makeText(NhatKyNhapHangChiTietActivity.this, "Lấy danh sách thất bại. Chi tiết:\n" + error, Toast.LENGTH_LONG).show();
            }
        });
    }

    private void onBindData() {
        adapterListData = new NhatKyNhapHangChiTietRecyclerViewAdapter(NhatKyNhapHangChiTietActivity.this, listData);
        adapterListData.DataSourceChanged(new NhatKyNhapHangChiTietRecyclerViewAdapter.DataSourceChangedListener() {
            @Override
    ...
    private void SummaryItems() {
        ...
        for (ChiTietNhapHangInfo item : adapterListData.getListAllData()) {
            tongSl += item.getSL();
            tongThanhTien += item.getThanh_Tien();
        }
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (position == DateReportInfo.LuaChonKhac) {
                    ...
                    NhapThoiGianBaoCaoDialog.getInstance().showConfirmDialog(dieuKienLoc.getTuNgay(), dieuKienLoc.getDenNgay(), NhatKyNhapHangChiTietActivity.this,
