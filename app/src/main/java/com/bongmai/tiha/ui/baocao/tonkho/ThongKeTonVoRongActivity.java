...
public class ThongKeTonVoRongActivity extends AppCompatActivity {
    ...
    BaseService service;
    ThongKeTonVoRongRecyclerViewAdapter adapterListData;
    List<DKNhapXuatTonVoRongListKhoKTG> listData;
    ...
    private void GetListData() {
        ...
        baoCaoPresenter.GetListThongKeTonVoRong(dieuKienLoc, new BaoCaoTonKhoContract.IOnGetListThongKeTonVoRongFinishedListener() {
            @Override
            ...
            public void onError(String error) {
                ...
                listData = new ArrayList<>();
                onBindData();
                Toast.makeText(ThongKeTonVoRongActivity.this, "Lấy danh sách thất bại. Chi tiết:\n" + error, Toast.LENGTH_LONG).show();
            }
        });
    }

    private void onBindData() {
        adapterListData = new ThongKeTonVoRongRecyclerViewAdapter(ThongKeTonVoRongActivity.this, listData);
        adapterListData.DataSourceChanged(new ThongKeTonVoRongRecyclerViewAdapter.DataSourceChangedListener() {
            @Override
    ...
    private void SummaryItems() {
        ...
        for (DKNhapXuatTonVoRongListKhoKTG item : adapterListData.getListAllData()) {
            tongDK += item.getDauKy();
            tongNhap += item.getNhap();
            tongXuat += item.getXuat();
            tongChuyenDen += item.getCDen();
            tongChuyenDi += item.getCDi();
            tongCuoiKy += item.getTonCuoi();
        }
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (position == DateReportInfo.LuaChonKhac) {
                    ...
                    NhapThoiGianBaoCaoDialog.getInstance().showConfirmDialog(dieuKienLoc.getTuNgay(), dieuKienLoc.getDenNgay(), ThongKeTonVoRongActivity.this,
