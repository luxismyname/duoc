...
public class DonViTinhSoDuVatTuDauAdapter extends ArrayAdapter<DonViTinhInfo> implements Filterable {
    private CustomFilterListData customFilterListData = new CustomFilterListData();
    Context context;
    int layoutID;
    List<DonViTinhInfo> listAllData;

    public DonViTinhSoDuVatTuDauAdapter(Context context, int layoutID, List<DonViTinhInfo> listAllData) {
