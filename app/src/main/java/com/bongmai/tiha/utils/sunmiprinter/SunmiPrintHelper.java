...
//            String soChungTu = "Số CT: " + phieuXuatInfo.getSoCt() + "\n";
//            String ngay = "Ngày: " + AppUtils.formatDateToString(phieuXuatInfo.getNgay(), "dd/MM/yyyy") + "\n";
//            String nhanVien = "Nhân viên: " + phieuXuatInfo.getDDBH() + "\n";
//            String kho = "Kho: " + phieuXuatInfo.getMSK() + "\n";
//            String luuY = "Lưu ý: " + bmConfigInfo.getLuuY();
//
//            sunmiPrinterService.setAlignment(1, null);
//            //Company
...
//
//            //Detail
//            String txts[] = new String[]{"SL", "G.Bán", "T.Tiền"};
...
//            //Thanks you
//            sunmiPrinterService.lineWrap(1, null);
//            sunmiPrinterService.printTextWithFont("Xin cảm ơn quý khách. Hẹn gặp lại!!", null, fontTitle, null);
//
//
//            try {
//                sunmiPrinterService.setPrinterStyle(WoyouConsts.SET_LINE_SPACING, 0);
...
//        }
            ...
            try {
                int paper = sunmiPrinterService.getPrinterPaper();
                sunmiPrinterService.printerInit(null);
                String company = "QUÁN CHAY TÂM ĐỨC" + "\n";
                String address = "Số 39 Đường số 3B, Phường Tân Tạo A, Quận Bình Tân, Tp.HCM" + "\n";
                String phone = "ĐT: 0962400292" + "\n" ;
                String request =  "(Nhận đặt tiệc chay)" + "\n";

                String title = "HÓA ĐƠN THANH TOÁN\n";

                String soChungTu = "Số hóa đơn: " + phieuXuatInfo.getSoCt().substring(phieuXuatInfo.getSoCt().length() -4) + "\n";
                String ngay = "Ngày thu: " + AppUtils.formatDateToString(phieuXuatInfo.getNgay(), "dd/MM/yyyy") + "\n";
//                String ngay = "Ngày thu: " + AppUtils.formatDateToDateRequestSQL(String.valueOf(phieuXuatInfo.getNgay()), "dd/MM/yyyy - HH:mm" ) + "\n";
                String soban = "Số bàn: 01" +"\n";
                String khachhang = "Khách hàng: "+ phieuXuatInfo.getTenDDnguoimua() +" - " + phieuXuatInfo.getDiachi() +" - "+phieuXuatInfo.getDTDD()+ "\n";
                String sdt = "SĐT: " + phieuXuatInfo.getDTDD()+ "\n";

                String nhanVien = "Thu ngân: Tâm Đức" + "\n";
                ...
                //Detail
                String txts[] = new String[]{"Số lượng", "Đơn giá", "Thành tiền"};
                ...
                //Tong tien
                String txtTongTien[] = new String[]{
                       AppUtils.formatNumber("N0").format(tongSL), "Tổng tiền:",
                        AppUtils.formatNumber("N0").format(tongTien)};
                ...
                //Thanks you
                sunmiPrinterService.lineWrap(1, null);
                sunmiPrinterService.printTextWithFont("Cảm ơn quý khách. Hẹn gặp lại" +"\n", null, fontTitle, null);
...
//            String title = "HÓA ĐƠN THANH TOÁN\n";
//
//            String soChungTu = "Số hóa đơn: " + phieuXuatInfo.getSoCt() + "\n";
//            String ngay = "Ngày thu: " + AppUtils.formatDateToString(phieuXuatInfo.getNgay(), "dd/MM/yyyy - HH:mm") + "\n";
//            String khachhang = "Khách hàng: " + phieuXuatInfo.getTennguoimua();
//            String nhanVien = "Thu ngân: Tâm Đức" + "\n";
//
//            sunmiPrinterService.setAlignment(1, null);
//            //Company
